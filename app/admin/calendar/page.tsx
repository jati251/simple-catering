...
export default function CalendarConfig() {
  ...
  const handleRemove = async (calendarId: string) => {
    if (!confirm('Are you sure you want to remove this menu from this date?')) return;
    try {
      await removeFoodFromDate(calendarId);
      await fetchData();
    } catch (err) {}
  };
            ...
            <div className="lg:col-span-8 flex flex-col gap-6">
                <div className="glass p-8 rounded-[3rem] border border-white/5 shadow-2xl relative overflow-hidden">
                    <div className="flex items-center justify-between mb-8">
                        <h2 className="text-2xl font-black italic uppercase tracking-tighter">Kitchen Schedule</h2>
                        <div className="flex gap-2">
                             <div className="flex items-center gap-2 text-[10px] font-bold text-muted-foreground mr-4">
                               <div className="w-3 h-3 rounded bg-primary" /> Assigned
                             </div>
                        </div>
                    </div>
            ...
            <div className="lg:col-span-4 space-y-6">
                ...
                >
                    ...
                    <div className="space-y-4">
                        <label className="text-[10px] font-black uppercase tracking-widest text-muted-foreground ml-1">Current Assignments</label>
                        <div className="space-y-2 mb-4">
                          ...
                          {calendarDays.find(d => d.isSelected)?.assignments.length === 0 && (
                            <p className="text-[10px] text-muted-foreground italic">No menus assigned yet.</p>
                          )}
                        </div>
