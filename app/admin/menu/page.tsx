                ...
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    ...
                    <input
                      type="text"
                      required
                      placeholder="e.g. Nasi Bakar D'MBG"
              ...
              <AnimatePresence mode="popLayout">
                      ...
                      >
                        <div className="flex gap-5">
                          ...
                          <div className="flex-1 space-y-1.5 pt-1">
                            <h3 className="text-xl font-black italic tracking-tighter leading-tight line-clamp-1">
                              {item.name}
                            </h3>
                            <p className="text-[10px] text-muted-foreground line-clamp-2 leading-relaxed font-semibold uppercase tracking-tight">
                ...
                {loading &&
                  [1, 2, 4, 4].map((i) => (
                    <div
                      key={i}
                      className="h-44 bg-white/5 animate-pulse rounded-[2.5rem] border border-white/5"
                    />
                  ))}
              </AnimatePresence>
            </div>
