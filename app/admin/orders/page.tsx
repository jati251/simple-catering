    ...
    <div className="max-w-6xl mx-auto px-6 py-12 pb-32">
        ...
        <div className="flex items-center justify-between mb-12">
            <div className="flex items-center gap-4">
                ...
                <div>
                  <h1 className="text-4xl font-black italic tracking-tighter leading-none text-white">Orders</h1>
            ...
            <div className="relative">
              ...
              <input 
                ...
                className="bg-white/5 border border-white/10 rounded-2xl pl-12 pr-6 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all w-64"
                value={searchTerm}
              ...
              <table className="w-full text-left">
                <thead>
                  <tr className="bg-white/5 border-b border-white/5">
                    <th className="px-8 py-6 text-[10px] font-black uppercase tracking-widest text-muted-foreground">Buyer</th>
                    <th className="px-8 py-6 text-[10px] font-black uppercase tracking-widest text-muted-foreground">Date / Menu</th>
                    <th className="px-8 py-6 text-[10px] font-black uppercase tracking-widest text-muted-foreground text-center">Payment Proof</th>
                    <th className="px-8 py-6 text-[10px] font-black uppercase tracking-widest text-muted-foreground text-right tracking-widest">Amount</th>
                  </tr>
                </thead>
                    ...
                    >
                      ...
                      <td className="px-8 py-6">
                        <div className="flex flex-col">
                          <span className="text-xs font-black text-primary uppercase tracking-tighter italic">
                            {new Date(order.expand?.calendar_id?.date || '').toLocaleDateString(undefined, { weekday: 'short', month: 'short', day: 'numeric' })}
                          </span>
                          <span className="text-sm font-medium text-muted-foreground italic line-clamp-1">
                      ...
                      <td className="px-8 py-6 text-center">
                        {order.payment_proof ? (
                          <a 
                            ...
                            className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-primary text-black font-black text-[10px] uppercase hover:scale-105 transition-all shadow-lg shadow-primary/20"
                          >
                            <Eye size={14} /> View Proof
                          </a>
                        ) : (
                          <span className="text-[10px] font-black text-red-500/50 uppercase italic">No Proof Uploaded</span>
                        )}
                      </td>
