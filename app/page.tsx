...
export default function Home() {
  ...
  const totalOrders = tomorrowOrders.reduce(
        ...
        <section className="flex flex-col lg:flex-row items-center justify-between gap-16 py-12 mb-20">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-lg leading-relaxed">
              Elevate your daily dining with professional chef-prepared meals
              delivered fresh to your doorstep. Simple ordering, premium taste.
            </p>
              ...
              <div className="flex items-center gap-6 px-4">
                <div className="flex -space-x-3">
                  {[1, 2, 3].map((i) => (
                    <div
                      key={i}
                      className="w-10 h-10 rounded-full border-2 border-background bg-zinc-800 overflow-hidden"
                    >
                      <img
                ...
                <div className="text-sm">
                  <p className="font-bold underline cursor-pointer hover:text-orange-500">
                    Join our community
                  </p>
                </div>
              </div>
          ...
          >
            <div className="w-full aspect-[4/5] rounded-[3rem] bg-gradient-to-br from-zinc-800 to-black shadow-[0_0_80px_-20px_rgba(249,115,22,0.3)] overflow-hidden relative group">
              ...
              <div className="absolute top-6 right-6 flex gap-2">
                <div className="glass px-3 py-1.5 rounded-full text-[10px] font-black uppercase tracking-tighter">
                  Premium
                </div>
                <div className="glass px-3 py-1.5 rounded-full text-[10px] font-black uppercase tracking-tighter text-orange-500">
                  Chef Special
                </div>
              </div>
              ...
              {loading ? (
                ...
                <div className="space-y-4">
                  <div className="space-y-1">
                    ...
                    <h3 className="text-4xl font-black text-white leading-tight">
                      {tomorrowMenu.expand?.menu_item?.name}
                    </h3>
                  </div>
                  <p className="text-muted-foreground text-sm line-clamp-3 leading-relaxed">
                    {tomorrowMenu.expand?.menu_item?.description}
                  </p>
                  <div className="pt-4 flex items-center gap-4">
                    <div className="text-2xl font-black text-orange-500 italic">
                      ${tomorrowMenu.expand?.menu_item?.price || "25"}
                    </div>
                ...
                <div className="text-center space-y-4">
                  ...
                  <p className="text-muted-foreground italic font-medium">
                    Chef is currently planning <br /> something amazing.
                  </p>
                </div>
              )}
            </div>
              ...
              {loading ? (
                ...
                <div className="h-full flex flex-col items-center justify-center text-center space-y-4 opacity-50">
                  ...
                  <p className="text-muted-foreground italic font-medium leading-relaxed">
                    Preparation starts when <br /> orders arrive.
                  </p>
                </div>
              )}
            </div>
